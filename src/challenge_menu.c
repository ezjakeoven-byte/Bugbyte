...
static const u8 *const sDesc_Bugbyte[] = {
    COMPOUND_STRING("BUGBYTE developer tools are disabled."),
    COMPOUND_STRING("Enable BUGBYTE developer tools\nfrom the START MENU."),
};
...
static const struct ChallengeMenuItem sTabItems_Features[] = {
    ...
    [ITEM_FEATURES_BUGBYTE] = {
    .name         = COMPOUND_STRING("BUGBYTE MODE"),
    .descriptions = sDesc_Bugbyte,
    .numChoices   = 2,
    .choiceNames  = sChoices_OffOn,
},
    [ITEM_FEATURES_NEXT] = {
