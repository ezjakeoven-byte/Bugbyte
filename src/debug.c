...
EWRAM_DATA u16 gDebugNextWildSpecies = SPECIES_NONE;
EWRAM_DATA bool8 gDebugNextWildShiny = FALSE;
...
static void DebugAction_NextWildSpecies(u8 taskId);
static void DebugAction_NextWildShiny(u8 taskId);
static void DebugAction_ClearNextWild(u8 taskId);
...
static const struct DebugMenuOption sDebugMenu_Actions_Give[] =
{
    ...
    { COMPOUND_STRING("Next Wild Species…"), DebugAction_NextWildSpecies },
    { COMPOUND_STRING("Next Wild Shiny"),    DebugAction_NextWildShiny },
    { COMPOUND_STRING("Clear Next Wild"),    DebugAction_ClearNextWild },
...
static void DebugAction_NextWildSpecies(u8 taskId)
{
    ...
    gTasks[taskId].tIsNextWild = TRUE;

    FreeMonIconPalettes();
    LoadMonIconPalettePersonality(species, 0);

    gTasks[taskId].tSpriteId = CreateMonIcon(
        species,
        SpriteCB_MonIcon,
        DEBUG_NUMBER_ICON_X,
        DEBUG_NUMBER_ICON_Y,
...
static void DebugAction_Give_PokemonSimple(u8 taskId)
{
    ...
    gTasks[taskId].tIsComplex = FALSE;
    gTasks[taskId].tIsEgg = FALSE;
    gTasks[taskId].tIsNextWild = FALSE;
...
static void DebugAction_ClearNextWild(u8 taskId)
{
    gDebugNextWildSpecies = SPECIES_NONE;
    gDebugNextWildShiny = FALSE;
...
static void DebugAction_Give_Pokemon_SelectId(u8 taskId)
{
    ...
    if (JOY_NEW(A_BUTTON))
    {
        ...
        if (gTasks[taskId].tIsNextWild)
{
    gDebugNextWildSpecies = sDebugMonData->species;
